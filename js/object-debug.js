/**
 * Created by michaelfestger on 4/14/17.
 */
/**
 * Debug Warm Up
 *
...
var pizza = {
    ...
    crust: 'stuffed', //added comma here
    delivery: true //removed comma
};

// output the type of crust for the pizza
console.log('The type of crust for the first pizza: ');

console.log(pizza.crust); // removed brackets and added .crust
...
var orders = [
    {
        ...
        crust: 'stuffed',
        delivery: true,
        price: 1295 // removed comma and added a decimal to the price to make it reasonable
    },
    {
        toppings: ['onion', 'salami'],
        crust: 'pretzel',
        delivery: false,
        price: 1195 // removed comma and added a decimal to the price to make it reasonable
    },
    {
        ...
        price: 995 // removed comma and added a decimal to the price to make it reasonable
    }
];

console.log('Here are the different crust types for each order: ');
orders.forEach(function(order) {
    console.log(order.crust) // replaced orders with order to match the forEach loop property
});
